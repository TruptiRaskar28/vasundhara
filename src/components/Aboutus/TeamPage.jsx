...
const TeamPage = () => {
  return (
    <section className="py-20 px-6 md:px-12">
      ...
      <div
        className="text-center text-white bg-black bg-opacity-50 p-8 -ml-6 sm:-ml-4 md:-ml-20 -mt-6 sm:-mt-4 md:-mt-20 rounded-lg mx-auto"
        style={{
      ...
      >
        <h2 className="text-4xl sm:text-3xl md:text-4xl font-bold mb-4">Vasundhara Sanstha’s method of working</h2>
        <p className="text-xl sm:text-lg md:text-xl mb-4">
        ...
        <h3 className="text-2xl sm:text-xl md:text-2xl font-bold mt-6">#Vasundhara Team</h3>
      </div>
      ...
      <div className="mt-12 text-center">
        <img
          src={teamImage}
          alt="Vasundhara Team"
          className="w-full max-w-4xl mx-auto rounded-lg shadow-lg sm:max-w-full md:max-w-4xl" // No background image applied here
        />
      </div>
    </section>
  );
